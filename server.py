...
def editevent():
	...
	stmt="SELECT o.eid, tt.type, ti.price FROM Owns_Tickets_Has_For o, Tick_Info ti, Tick_Type tt where o.eid = %s and o.eid=ti.eid and ti.typeid = tt.typeid and o.typeid = ti.typeid"
	cursor=g.conn.execute(stmt, (eid,))
	tpr=[]
	for result in cursor:
		tpr.append(result)
